...
class JiraMCPServerConfig:
    """Configuration for Jira MCP server error handling."""

    mask_error_details: bool = field(
        default_factory=lambda: is_env_truthy("JIRA_MCP_MASK_ERROR_DETAILS", "true")
    )


# Set FastMCP environment variable based on our configuration
_jira_config = JiraMCPServerConfig()
if not _jira_config.mask_error_details:
