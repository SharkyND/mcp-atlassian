    ...
    def from_env(cls) -> "XrayConfig":
        ...
        if oauth_config:
            ...
            if username and api_token:
                ...
                error_msg = "Cloud authentication requires XRAY_USERNAME and XRAY_API_TOKEN, or OAuth configuration (set ATLASSIAN_OAUTH_ENABLE=true for user-provided tokens)"
                raise ValueError(error_msg)
